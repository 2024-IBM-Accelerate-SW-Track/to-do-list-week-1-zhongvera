    ...
    render() {
      return (
        ...
        <div>
          ...
          label="Add New Item"
          variant="outlined"
          onChange={this.handleChange} // Connects the handleChange method
          value={this.state.content} // Reflects the current state
          data-testid="new-item-textfield" // Added data-testid for testing
          />
          <Button
          style={{ marginLeft: "10px" }}
          onClick={this.handleSubmit} // Connects the handleSubmit method
          variant="contained"
          color="primary"
          data-testid="new-item-button"  // Added data-testid for testing
          >
          Add
          </Button>
        </div>
